...
def hello_world(request):
    ...
    if request_json and 'message' in request_json:
        ...
        url = 'https://www.crunchbase.com/v4/data/entities/ipos/{}?field_ids=%5B%22identifier%22,%22layout_id%22,%22facet_ids%22,%22title%22,%22short_description%22,%22is_locked%22%5D&layout_mode=view_v2'.format(
            c_l)
        headers = {
