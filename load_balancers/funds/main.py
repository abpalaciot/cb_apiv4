...
def run(data):
    ...
    urls = ['https://europe-west1-cb-data-fetch.cloudfunctions.net/funds_simple_ent_f0',
            'https://asia-east2-cb-data-fetch.cloudfunctions.net/funds_simple_ent_f1',
            'https://asia-northeast2-cb-data-fetch.cloudfunctions.net/funds_simple_ent_f2'
            ]
    x = 0
    retry = []
